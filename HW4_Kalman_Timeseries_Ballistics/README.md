...
2. Вспомним школьную программу. Кто-то зачем-то выстрелил из пушки по воробьям. В воробьев не попал, но зато старательно измерил координаты (𝑥𝑖,𝑦𝑖) летящего ядра 
