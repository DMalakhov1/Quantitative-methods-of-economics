...
Вспомним школьную программу. Кто-то зачем-то выстрелил из пушки по воробьям. В воробьев не попал, но зато старательно измерил координаты (𝑥𝑖,𝑦𝑖) летящего ядра 
(см. прикрепленный файл). Ядро было выпущено с начальной скоростью 𝑣0 под углом 𝛼 к горизонту.
